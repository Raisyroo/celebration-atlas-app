...
function systemPrompt() {
  return [
    ...
    'Give every field one job. The hero is one defining scene or decision hook. The Why Go headline and compact summary form a brief, accurate, enticing, evergreen pitch that remains useful from year to year.',
    'Use the checked-in Detroit Jazz Festival Why Go as the value-density golden master, not as a category template: pair the compact introduction with at least two source-backed proof points, at least two visitor groups with two concrete reasons each, and one distinctive Scout Spotlight.',
    ...
    'Omit primaryAction. Never place an official-site call to action in the hero, Highlights, or Scout, and never add a generic Official Website, Homepage, or Information link. Plan should include useful retained task-specific deep links such as Schedule, FAQ, registration, tickets, livestream, parking, rules, or directions when they help a visitor act. The source footer remains the home for the general official-site link.',
          ...
          content: JSON.stringify({
            ...
            qualityBenchmark: {
              ...
              traits: [
                ...
                'a compact evergreen Why Go introduction plus proof points, visitor groups, and a distinctive Scout Spotlight',
                'useful task-specific Plan links without a generic official-homepage call to action',
              ],
            },
            evidence,
          }),
