...
export const MICHIGAN_COMPLETION_STAGES: readonly MichiganCompletionStageDefinition[] = [
  ...
  },
  {
    ...
    exceptionCodes: ["missing_approved_image", "image_provenance_failure"],
    blocksLaterStages: false,
    requiredForEveryEvent: true,
  },
  {
  ...
  },
  {
    ...
    idempotencyContract: "Frozen package, approved visual, and current exception state.",
    ...
    exceptionCodes: ["publication_readiness_failure", "missing_approved_image", "image_provenance_failure"],
    blocksLaterStages: true,
    requiredForEveryEvent: true,
  },
] as const;
