...
const styles: Record<string, CSSProperties> = {
  ...
  activeScrollRegion: { overflowY: 'auto', overscrollBehavior: 'contain', padding: '1rem 1rem 1.1rem', display: 'grid', alignContent: 'start', gap: '0.62rem' },
