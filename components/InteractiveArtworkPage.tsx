...
const styles: Record<string, CSSProperties> = {
  ...
  goodellsAskDock: { left: 'calc(env(safe-area-inset-left, 0px) + 0.78rem)', right: 'calc(env(safe-area-inset-right, 0px) + 0.78rem)', width: 'auto', maxWidth: '100%', boxSizing: 'border-box', bottom: 'max(5%, calc(env(safe-area-inset-bottom, 0px) + 0.95rem))', position: 'absolute', padding: '0.54rem 0.62rem', gap: '0.56rem', borderRadius: '1.14rem' },
