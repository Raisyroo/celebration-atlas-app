...
const styles: Record<string, CSSProperties> = {
  ...
  goodellsArtworkFrame: { width: 'fit-content', maxWidth: '100%', maxHeight: '100dvh', margin: '0 auto', overflow: 'hidden' },
  artworkImage: { display: 'block', width: '100%', height: 'auto', objectFit: 'contain' },
  goodellsArtworkImage: { width: 'auto', height: 'auto', maxWidth: '100%', maxHeight: '100dvh', objectFit: 'contain', objectPosition: 'center top' },
