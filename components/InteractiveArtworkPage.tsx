...
const styles: Record<string, CSSProperties> = {
  ...
  goodellsPage: { width: '100vw', height: '100dvh', overflow: 'hidden' },
  artworkStage: { position: 'relative', minHeight: '100dvh', overflowX: 'hidden', overflowY: 'visible', maxWidth: '760px', margin: '0 auto' },
  goodellsArtworkStage: { width: '100vw', height: '100dvh', minHeight: '100dvh', overflow: 'hidden', display: 'grid', placeItems: 'center', margin: 0, maxWidth: 'none', padding: 0 },
  artworkImage: { display: 'block', width: '100%', height: 'auto', objectFit: 'contain' },
  goodellsArtworkImage: { width: '100vw', height: '100dvh', maxWidth: 'none', maxHeight: 'none', objectFit: 'contain', objectPosition: 'center top' },
  ...
  goodellsAskDock: { left: '16px', right: '16px', width: 'auto', maxWidth: 'calc(100vw - 32px)', boxSizing: 'border-box', bottom: 'max(16px, calc(env(safe-area-inset-bottom, 0px) + 0.95rem))' },
