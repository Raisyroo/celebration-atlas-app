...
const styles: Record<string, CSSProperties> = {
  ...
  goodellsArtworkStage: { width: '100vw', height: '100dvh', minHeight: '100dvh', overflow: 'hidden', display: 'grid', placeItems: 'center', margin: 0, maxWidth: '100vw' },
  artworkImage: { display: 'block', width: '100%', height: 'auto', objectFit: 'contain' },
  goodellsArtworkImage: { maxWidth: '100vw', maxHeight: '100dvh', width: 'auto', height: '100dvh', objectFit: 'contain', objectPosition: 'center center' },
