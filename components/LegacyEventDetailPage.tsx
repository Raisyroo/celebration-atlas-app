...
import InteractiveArtworkPage from './InteractiveArtworkPage';
import AtlasAIResponseDemo from './AtlasAIResponseDemo';
import RomeoAtlasWindowPage from './RomeoAtlasWindowPage';
...
export default function LegacyEventDetailPage() {
