...
const HIGHLIGHTS_CONTENT_OFFSET_Y = "-12px";
...
const ATLAS_WINDOW_MIN_ICON_CLEARANCE_PX = 0;
...
const styles: Record<string, CSSProperties> = {
  ...
  floatingMemoryLayout: {
    ...
    WebkitMaskImage:
      "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.72) 3%, rgba(0,0,0,0.96) 5.75%, black 7%, black 93%, rgba(0,0,0,0.96) 94.25%, rgba(0,0,0,0.72) 97%, transparent 100%)",
    maskImage:
      "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.72) 3%, rgba(0,0,0,0.96) 5.75%, black 7%, black 93%, rgba(0,0,0,0.96) 94.25%, rgba(0,0,0,0.72) 97%, transparent 100%)",
  ...
  bottomZone: {
    ...
    display: "grid",
    gap: "0.62rem",
    width: "min(calc(100vw - 1.44rem), calc(760px - 1.44rem))",
