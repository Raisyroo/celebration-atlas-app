...
const styles: Record<string, CSSProperties> = {
  ...
  romeoMediaWrap: {
    ...
    overflow: 'hidden',
    maskImage:
      'linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(0,0,0,.06) 12%, rgba(0,0,0,.45) 30%, rgba(0,0,0,.82) 52%, rgba(0,0,0,.96) 70%, rgba(0,0,0,1) 100%), linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,.44) 14%, rgba(0,0,0,.88) 32%, rgba(0,0,0,1) 100%), linear-gradient(0deg, rgba(0,0,0,0) 0%, rgba(0,0,0,.44) 14%, rgba(0,0,0,.88) 32%, rgba(0,0,0,1) 100%), linear-gradient(270deg, rgba(0,0,0,.86) 0%, rgba(0,0,0,.95) 18%, rgba(0,0,0,1) 44%, rgba(0,0,0,1) 100%), radial-gradient(120% 118% at 86% 54%, rgba(0,0,0,1) 36%, rgba(0,0,0,.9) 60%, rgba(0,0,0,.7) 76%, rgba(0,0,0,.34) 90%, rgba(0,0,0,.04) 100%)',
    WebkitMaskImage:
      'linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(0,0,0,.06) 12%, rgba(0,0,0,.45) 30%, rgba(0,0,0,.82) 52%, rgba(0,0,0,.96) 70%, rgba(0,0,0,1) 100%), linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,.44) 14%, rgba(0,0,0,.88) 32%, rgba(0,0,0,1) 100%), linear-gradient(0deg, rgba(0,0,0,0) 0%, rgba(0,0,0,.44) 14%, rgba(0,0,0,.88) 32%, rgba(0,0,0,1) 100%), linear-gradient(270deg, rgba(0,0,0,.86) 0%, rgba(0,0,0,.95) 18%, rgba(0,0,0,1) 44%, rgba(0,0,0,1) 100%), radial-gradient(120% 118% at 86% 54%, rgba(0,0,0,1) 36%, rgba(0,0,0,.9) 60%, rgba(0,0,0,.7) 76%, rgba(0,0,0,.34) 90%, rgba(0,0,0,.04) 100%)',
