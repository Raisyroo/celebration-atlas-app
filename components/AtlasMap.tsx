...
const styles: Record<string, CSSProperties> = {
  ...
  mobileLiveCard: {
    ...
    background: 'linear-gradient(150deg, rgba(29, 36, 48, 0.78), rgba(7, 11, 18, 0.82))',
    color: '#f7e9c8',
    textAlign: 'left',
    cursor: 'pointer',
    touchAction: 'manipulation',
  ...
  mobileLiveCardGradient: {
    ...
    zIndex: 1,
    background:
      'linear-gradient(180deg, rgba(4, 6, 10, 0.34) 0%, rgba(4, 6, 10, 0.1) 34%, rgba(4, 6, 10, 0.76) 70%, rgba(3, 4, 8, 0.96) 100%), radial-gradient(circle at 18% 8%, rgba(255, 222, 155, 0.18), rgba(255, 222, 155, 0) 34%)',
    pointerEvents: 'none',
  },
