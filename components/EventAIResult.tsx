...
import EventAIPlaceholder from './EventAIPlaceholder';

type EventAIResultProps = {
  eventName: string;
};

export default function EventAIResult({ eventName }: EventAIResultProps) {
  return (
    <section style={styles.wrap} aria-label="Universal AI result panel">
      ...
      <div style={styles.stack}>
        <EventAIPlaceholder type="answer" />
        <EventAIPlaceholder type="checklist" />
        <EventAIPlaceholder type="itinerary" />
        <EventAIPlaceholder type="mapPreview" />
        <EventAIPlaceholder type="sourceConfidence" />
      </div>
    </section>
  );
}
